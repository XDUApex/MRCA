...
# 读取实验结果数据
experiment_results1_tt = pd.read_csv('RCA/result-8-22.csv')
experiment_results2_tt = pd.read_csv('RCA/result-8-23.csv')
experiment_results1_ob = pd.read_csv('RCA/result-1-29.csv')
experiment_results2_ob = pd.read_csv('RCA/result-1-30.csv')
# 读取ground truth数据
